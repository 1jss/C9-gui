...
void draw_superellipse_border_point(SDL_Renderer *renderer, i32 center_x, i32 center_y, i32 radius, f32 t) {
...
void draw_superellipse(SDL_Renderer *renderer, i32 center_x, i32 center_y, i32 radius) {
  ...
  for (f32 t = 0; t < 2 * M_PI; t += step) {
    draw_superellipse_border_point(renderer, center_x, center_y, radius, t);
  }
}

// Draws a rectangle with superellipse corners
void draw_rounded_rectangle(SDL_Renderer *renderer, i32 x, i32 y, i32 rectangle_width, i32 rectangle_height, i32 corner_radius) {
  ...
  for (f32 t = 0; t <= M_PI / 2; t += step) {
    ...
    draw_superellipse_border_point(renderer, x + rectangle_width - corner_radius, y + rectangle_height - corner_radius, corner_radius, t);
    // Bottom left corner (t + M_PI / 2)
    draw_superellipse_border_point(renderer, x + corner_radius, y + rectangle_height - corner_radius, corner_radius, t + M_PI / 2);
    // Top left corner (t + M_PI)
    draw_superellipse_border_point(renderer, x + corner_radius, y + corner_radius, corner_radius, t + M_PI);
    // Top right corner (t + 3 * M_PI / 2)
    draw_superellipse_border_point(renderer, x + rectangle_width - corner_radius, y + corner_radius, corner_radius, t + 3 * M_PI / 2);
  }
}
...
i32 main() {
  ...
  while (!done) {
    ...
    if (redraw) {
      ...
      draw_rounded_rectangle(renderer, 100, 100, 300, 400, 60);
      draw_rounded_rectangle(renderer, 200, 110, 400, 300, 150);
      draw_rounded_rectangle(renderer, 10, 10, 600, 40, 30);
